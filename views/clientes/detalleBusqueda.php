<?php
  ...
  require_once("../../controllers/cliente/detalles.php");
...
<header>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="productos-nav-ul">
                      <!-- Menu compras del cliente  -->
                        ...
                        <li class="nav-item" data-index="1">
                            <a href="productosC.php" class="nav-link active" id="productos" aria-current="page" style="color:white ">Productos</a>
                        </li>
    ...
    <main>
        ...
        <?php
            include_once '../../controllers/cliente/detalles.php'; // Asegúrate de que se incluya solo una vez
