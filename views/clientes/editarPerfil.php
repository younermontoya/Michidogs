        ...
        <div class="tab-content">
          <div id="signup">   
            ...
            <div class="top-row">
              <div class="field-wrap">
                ...
                <input class="edit" type="text" required autocomplete="off" />
              </div>
            ...
            <div class="field-wrap">
              ...
              <input class="edit" type="email"required autocomplete="off"/>
            </div>
            ...
            <div class="field-wrap">
              ...
              <input class="edit" type="number"required autocomplete="off"/>
            </div>
          ...
          <div id="login">   
            ...
            <form action="/" method="post">
              ...
              <input class="edit" type="password"required autocomplete="off"/>
            </div>
            ...
            <button class="button button-block">Modificar</button>
