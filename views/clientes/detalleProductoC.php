...
<head>
    ...
    <title>MichiDogs</title>
     ...
     <script src="https://code.jquery.com/jquery-3.6.4.min.js" integrity="sha256-oP2kVbshkdYFbSBH+TrxUltrouq9UHg9X+Zo+UV1U8U=" crossorigin="anonymous"></script>
...
<header>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="productos-nav-ul">
                      <!-- Menu compras del cliente  -->
                        ...
                        <li class="nav-item" data-index="1">
                            <a href="productosC.php" class="nav-link active" id="productos" aria-current="page" style="ccolor: white">Productos</a>
                        </li>
    ...
    <main>
        ...
        <section id="containerProdClientes">
                  <?php
