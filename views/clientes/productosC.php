              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="productos-nav-ul">
                ...
                <!-- <li class="nav-item" id="comprasCliente" data-index="0">
                        ...
                        <li class="nav-item" data-index="1">
                            <a href="productosC.php" class="nav-link active" id="productos" aria-current="page">Productos</a>
                        </li>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item carouselHeader">
          <img
            src="https://img.freepik.com/vector-gratis/diseno-plantilla-tienda-mascotas-dibujada-mano_23-2150339791.jpg?t=st=1725282712~exp=1725286312~hmac=9f83da90fad7eb2bb4f2096c1a0053687cd58fdf4bc17e459f6fe340a272b664&w=1380"
            class="d-block w-100" alt="..." />
        </div>
        <div class="carousel-item carouselHeader">
          <img
