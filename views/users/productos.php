    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item carouselHeader active">
          <img
            src="https://img.freepik.com/vector-gratis/plantilla-tienda-mascotas-dibujada-mano_23-2150404420.jpg?t=st=1725283147~exp=1725286747~hmac=b85bba2ac9e406f6c53c5a08b7329b81f54e0602b51bbf146b2ecbc01308ee56&w=1380"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Mensaje de sesión no iniciada y botón para iniciar sesión -->
                    <div id="noSesion">
                        <p>Aún no hay una sesión iniciada, por favor ingresa con tu cuenta.</p>
                        <button type="button" class="botonNavInicio" data-bs-toggle="modal" data-bs-target="#inicio">
                            Iniciar sesión <img src="https://media.tenor.com/lOJVstiH6AwAAAAi/huella-perrito-patita-footprint.gif" alt="" height="30px" width="30px">
                        </button>
                    </div>
                    <div class="shopping-cart" style="display: none;">
                        ...
                        <div class="product">
                            <div class="product-image">
                                <img src="" height="150px" width="100px" alt="Imagen producto">
                            </div>
                            <div class="product-details">
                                <div class="product-title"><h4></h4></div>
                            </div>
                ...
                <div class="modal-body">
                    <form action="../../controllers/cliente/inicioController.php" id="login" method="POST">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <input type="password" class="form-control inputInicios" required name="contrasena" id="conContrasena" placeholder="Contraseña"/>
                            </div>
                        </div>
