...
require_once('../../Models/mensajesContacto.php');
require_once('../../Models/buscadorPeticiones.php');
?>
...
<head>
  ...
  <script>
        document.addEventListener("DOMContentLoaded", function() {
            var alertMessage = "<?php echo addslashes($alert_message); ?>";
            if (alertMessage) {
                alert(alertMessage);
            }
        });
  ...
  <link rel="stylesheet" href="/css/dataTableEstyle.css">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
    integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">

    </head>

<body class="dark-edition" data-page="verProductosAdmin">
  <div class="wrapper " id="contenedorPrincipal">
    <div class="sidebar" id="contenedorPrincipal" data-color="purple" data-background-color="black"
      data-image="../../img/perroSanti.jpeg">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Lista de peticiones</a>         
          </div>
...
<!-- CONTENIDO RESPUESTA DE PETICIÓN -->
<meta charset="UTF-8">
    <title>Administrar Peticiones</title>
    <style>
        table {
                ...
                <div class="col-md-12"> 
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Administrar Peticiones</h4>
                        </div>

                        <div class="card-body">
                            <div class="table-responsive">
                                <!-- Formulario de búsqueda -->
                                <form method="GET" action=""   style="display:flex; margin-bottom: 30px; gap: 10px; justify-content: flex-start;">
                                    <input type="text" name="search" placeholder="Buscar..." style="min-width: 20%;" value="<?php echo htmlspecialchars($_GET['search'] ?? ''); ?>">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="" method="POST">
                                                            <input type="hidden" name="mensaje_contacto_id" value="<?php echo htmlspecialchars($mensaje['id']); ?>">
                                                            <label for="respuesta_<?php echo htmlspecialchars($mensaje['id']); ?>">Respuesta:</label><br>
                                                            <textarea id="respuesta_<?php echo htmlspecialchars($mensaje['id']); ?>" name="respuesta" rows="4" cols="50" required></textarea><br>
                                                            <label for="estado_<?php echo htmlspecialchars($mensaje['id']); ?>">Estado:</label><br>
                                                            <select id="estado_<?php echo htmlspecialchars($mensaje['id']); ?>" name="estado" required>
                                                                <option value="en espera" <?php if ($mensaje['estado'] == 'en espera') echo 'selected'; ?>>En espera</option>
                                                                <option value="resuelta" <?php if ($mensaje['estado'] == 'resuelta') echo 'selected'; ?>>Resuelta</option>
                                                            </select><br><br>
...
<div class="modal-header">
  <h1 class="modal-title fs-5" id="exampleModalLabel"> Estado Del Producto </h1>
  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body">
  <div class="mb-3">
    <label for="recipient-name" class="col-form-label"> Modificacion de estado del producto: </label>
    <select name="estadoCliente" class="form-control" id="estadoProducto">
      <option value="Disponible">Disponible</option>
      <option value="Sin Existencia">Sin existencias</option>
    </select>
  </div>
</div>
