...
require_once('../../controllers/administrador/graficosFuncion.php');
...
<script type="text/javascript">
    ...
    function drawCharts() {
        ...
        drawSalesTrendsChart();
        drawCustomerAnalysisChart();
    }

    function drawCategorySalesChart() {
        fetch('../../controllers/administrador/graficosFuncion.php?action=categorySales')
            ...
            .then(data => {
                ...
                data.forEach(row => {
                    chartData.addRow([row.categoria, parseInt(row.ventas)]);
                });
    ...
    function drawSalesTrendsChart() {
        fetch('../../controllers/administrador/graficosFuncion.php?action=salesTrends')
            .then(response => response.json())
            .then(data => {
                var chartData = new google.visualization.DataTable();
                ...
                chartData.addColumn('number', 'Ventas');
                data.forEach(row => {
                    chartData.addRow([row.fecha, parseInt(row.total_ventas)]);
                });
            ...
            .catch(error => console.error('Error fetching sales trends data:', error));
    }

    function drawCustomerAnalysisChart() {
        fetch('../../controllers/administrador/graficosFuncion.php?action=customerAnalysis')
            .then(response => response.json())
            .then(data => {
                var chartData = new google.visualization.DataTable();
                ...
                data.forEach(row => {
                    chartData.addRow([row.producto, parseInt(row.total_ventas)]);
                });

                var options = {
                    title: 'Análisis de Compras por Cliente',
                    hAxis: { title: 'Cliente', titleTextStyle: { color: '#333' } },
                    vAxis: { minValue: 0 },
...
<body class="dark-edition" id="layout" data-page="perfilUsuario">
  <div class="wrapper" >
    <div class="sidebar"  data-color="purple" data-background-color="black" data-image="/img/perroSanti.jpeg"> 
      <div class="logo"><a href="#" class="simple-text logo-normal">
        <img class="logo-michi" src="https://ffuofqj.stripocdn.email/content/guids/CABINET_3bd76a577384bab22196b91e67aa8324f155ab163c9d6fb3f12980b288b12948/images/logosin_fondo.png" style="width: 80px; height: 80px;" alt="Logo Michi">
        Tu amigo fiel
        </a></div>
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Estadisticas</a>
          </div>
      ...
      <!-- COTENIDO DE LAS GRAFICAS DE ESTADISTICAS -->
