...
<form action="../../controllers/administrador/modificarPerfil.php" method="post">
...
<form action="../../controllers/administrador/cambiarContrasena.php" method="POST" enctype="multipart/form-data">
                <div class="row">
