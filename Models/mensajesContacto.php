...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['respuesta'])) {
    if (isset($_POST['mensaje_contacto_id']) && isset($_POST['respuesta']) && isset($_POST['estado'])) {
        ...
        try {
            ...
            if (!empty($user_email)) {
                ...
                try {
                    ...
                    $mail->isHTML(true);
                    $mail->Subject = 'Respuesta a tu peticion en Michidogs';
                    $mail->Body    = '
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="es" style="padding:0;Margin:0">
 <head>
  ...
  <title>Mensaje de contacto</title><!--[if (mso 16)]>
    <style type="text/css">
       ...
       <table cellpadding="0" cellspacing="0" class="es-header" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:transparent;background-repeat:repeat;background-position:center top">
         <tr style="border-collapse:collapse">
          <td class="es-adaptive" align="center" style="padding:0;Margin:0">
           <table class="es-header-body" cellspacing="0" cellpadding="0" align="center" bgcolor="#3b3636" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#3b3636;border-top:5px solid transparent;width:580px;border-bottom:5px solid transparent" role="none">
             <tr style="border-collapse:collapse">
                     ...
                     <tr style="border-collapse:collapse">
                      <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:459px">
                       <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                         <tr style="border-collapse:collapse">
                          <td align="center" height="115" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, arial, verdana, sans-serif;line-height:34px;color:#ffffff;font-size:34px"><strong><span style="line-height:100%">MENSAJE DE CONTACTO RECIBIDO</span></strong></p></td>
                         </tr>
                       </table></td>
                     </tr>
                   </table></td>
                   ...
                   <table class="es-right" cellpadding="0" cellspacing="0" align="right" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
                     <tr style="border-collapse:collapse">
                      <td align="left" style="padding:0;Margin:0;width:121px">
                       <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                         <tr style="border-collapse:collapse">
                          <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-top:10px;padding-right:40px;font-size:0px"><img src="https://ffuofqj.stripocdn.email/content/guids/CABINET_5785499cdfff6bf03aa878e6a4b03cd7c46d5860b936deae9b98915b74758690/images/logosin_fondo_Yp0.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="81"></td>
                         </tr>
                       </table></td>
                     </tr>
                   </table></td>
         ...
         <tr style="border-collapse:collapse">
          <td align="center" style="padding:0;Margin:0">
           <table class="es-content-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#fdfcdd;width:580px" cellspacing="0" cellpadding="0" bgcolor="#fdfcdd" align="center" role="none">
             <tr style="border-collapse:collapse">
              <td align="left" style="padding:0;Margin:0;padding-top:15px;padding-left:40px">
               <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr style="border-collapse:collapse">
                   ...
                   <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px" width="100%" cellspacing="0" cellpadding="0" role="presentation">
                       <tr  style="border-collapse:collapse">
                                                                                                        <td align="left" class="esd-block-text es-p20t es-p20b" style="padding: 40px;" >
                                                                                                            <p style="font-size: 15px; font-family: helvetica, arial, sans-serif;"><strong>Hola, </p>
                                                                                                            <p style="font-size: 15px; font-family: helvetica, arial, sans-serif;"><strong>Tu peticion ha sido respondida.</p>
                                                                                                            <p style="font-size: 15px; font-family: helvetica, arial, sans-serif;"><strong>Respuesta: ' . htmlspecialchars($respuesta) . ' </strong></p>
                                                                                                            <p style="font-size: 15px; font-family: helvetica, arial, sans-serif;"><strong>Estado: ' . htmlspecialchars($estado) . ' </strong></p>
                                                                                                            <p style="font-size: 15px; font-family: helvetica, arial, sans-serif;"><strong>Gracias por contactarnos. </strong></p>
                                                                                                            <p style="font-size: 15px; font-family: helvetica, arial, sans-serif;"><strong> Saludos,<br>El equipo de Michidogs. </strong></p>
                                                                                                        </td>
                                                                                                    </tr>
                   </table></td>
                 </tr>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr style="border-collapse:collapse">
                  <td align="center" valign="top" style="padding:0;Margin:0;width:580px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr style="border-collapse:collapse">
                      <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:25px;font-size:0px"><img src="https://ffuofqj.stripocdn.email/content/guids/CABINET_5785499cdfff6bf03aa878e6a4b03cd7c46d5860b936deae9b98915b74758690/images/xd.jpg" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" height="132"></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
             ...
             <tr style="border-collapse:collapse">
              <td align="left" style="Margin:0;padding-top:15px;padding-bottom:20px;padding-left:20px;padding-right:20px;border-radius:5px">
               <table width="100%" cellspacing="0" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                ...
                echo '<script>alert("Error: El correo electrónico del usuario no está disponible.")</script>';
            }
        } catch (PDOException $e) {
            echo "<p>Error: " . $e->getMessage() . "</p>";
        }
    } else {
        echo '<script>alert("Error: Faltan datos del formulario.")</script>';
    }
}

// Obtener las peticiones
$sql_peticiones = "SELECT * FROM mensajes_contacto";
$stmt_peticiones = $db->prepare($sql_peticiones);
$stmt_peticiones->execute();
$peticiones = $stmt_peticiones->fetchAll(PDO::FETCH_ASSOC);
?>
